...
public class ToDoService : ToDoIt.ToDoItBase
{
    ...
    {
        if (request.Id <= 0)
            throw new RpcException(new Status(StatusCode.InvalidArgument, "resource index must greater than zero"));
        ...
        throw new RpcException(new Status(StatusCode.NotFound, $"No task width id {request.Id}"));
    }
